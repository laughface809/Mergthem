...
const config = {
	metadata: {
		shortTitle: 'Mergthem',
		title: 'Mergthem - Online PDF Merger',
		author: 'laughface809',
		authorUsername: 'jerboa88',
		shortDescription: 'Mergthem is an online tool to combine multiple PDF files into one',
		description: 'Mergthem is an online tool to combine multiple PDF files into one. Mergthem has no ads, no file size limits, and your files never leave your device.',
		ogImageUrl: 'images/og-image.png',
		ogImageAltText: 'Mergthem logo',
		siteUrl: 'https://Mergthem.laughface809.io/',
		githubUrl: 'https://github.com/jerboa88/Mergthem/',
		homepageDomain: 'laughface809.io',
